...
function createRenderer(options) {
    ...
    function patch(n1, n2, container, parentNodeComponent) {
        // component
        // shapeFlags
        // vnode -> flag
        // element
    ...
    function processElement(n1, n2, container, parentNodeComponent) {
        if (!n1) {
    ...
    function processComponent(n1, n2, container, parentNodeComponent) {
    ...
    function processFragment(n1, n2, container, parentNodeComponent) {
    ...
    function mountElement(vnode, container, parentNodeComponent) {
        // createElement
        // mountElement -> patch
        // before
    ...
    function mountComponent(initialVNode, container, parentNodeComponent) {
        const instance = createComponentInstance(initialVNode, parentNodeComponent);
        setupComponent(instance);
        // debugger
        setupRenderEffect(instance, container, initialVNode);
    }
    function mountChildren(vnode, container, parentNodeComponent) {
